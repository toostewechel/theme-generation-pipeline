...
- [x] **COLR-04**: ~~Light color mode tokens emit under `[data-color-mode='light']`~~ — Removed as redundant; `:root` already serves as light mode default (quick task 1, 2026-02-16)
...
| COLR-04 | Phase 2 | Removed (redundant with COLR-03) |
...
**Coverage:**
- v1 requirements: 25 total (1 removed as redundant)
- Mapped to phases: 24
- Unmapped: 0

---
*Requirements defined: 2026-02-14*
*Last updated: 2026-02-16 — COLR-04 removed as redundant (quick task 1)*
